...
export default function CustumerDashboard() {
    ...
    return (
        <div className="p-4 space-y-4 max-w-[1400px] mx-auto w-full">
            ...
            <h2 className="text-lg md:text-[2rem] font-semibold text-[#00c951]">Destaques</h2>

            <Carousel
                plugins={[plugin.current]}
                className="w-full hover:scale-101 transition-transform"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4 md:gap-5">
                    {
                        upcomingAppointments.length > 0 ?
                            upcomingAppointments.map((appt) => (
                                <Card key={appt.id} className="transition-transform hover:scale-101">
            ...
            <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-5">
                    {recommendedServices.map((service) => (
                        <Card key={service.id} className="overflow-hidden rounded-xl shadow-md hover:scale-101 transition-transform flex flex-col">
                            ...
                            <CardContent className="p-3 flex flex-col flex-1 justify-between">
                                ...
                                <Button
                                    ...
                                    size="sm"
                                    onClick={() => navigate(`/dashboard/client/book/?id=${service.id}`)}
                                >
                                    Agendar
                                </Button>
                            </CardContent>
